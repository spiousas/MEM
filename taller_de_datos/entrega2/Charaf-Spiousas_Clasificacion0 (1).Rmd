...
Luego, ajustamos el modelo con los parámetros óptimos con toda la muestra de entrenamiento y evaluamos sobre la muestra de testeo el F1 obteniendo un resultado de `r round(max(f1_test_2vars, digits=3)` El valor del error de clasificación para los datos de testeo con dos variables es `r round(error_test_2vars, digits=3)`.
