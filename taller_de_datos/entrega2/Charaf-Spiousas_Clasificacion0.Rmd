...
```{r, warning = FALSE, fig.align="center", fig.height = 6, fig.width = 8, fig.cap = "\\label{fig:explo1}Residuos vs. valores ajustados para el modelo PCR."}
DMD_model %>%
  pivot_longer(CK:LD,
               values_to = "value",
               names_to = "Marcador") %>%
  ...
  labs(x = "Portadora",
       ...
       color = NULL) +
  stat_summary(geom = "bar", alpha = 0, color = "gray50", width = .4) +
