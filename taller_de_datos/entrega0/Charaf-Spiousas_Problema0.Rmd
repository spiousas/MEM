...
```{r interacccion_1, echo=FALSE, fig.align="center", fig.height = 3, fig.width = 4, fig.cap= "Gráfico de interacción entre tratamiento y tipo de veneno. El tipo de veneno está representado en el eje x mientras que el tipo de tratamiento está codificado por el color de la línea."}
data_veneno %>%
...
```{r interacccion_2, echo=FALSE, fig.align="center", fig.height = 3, fig.width = 4, fig.cap= "Gráfico de interacción entre tratamiento y tipo de veneno. El tipo de tratamiento está representado en el eje x mientras que el tipo de veneno está codificado por el color de la línea."}
data_veneno %>%
  group_by(veneno, tratamiento) %>%
  summarise(m_sobrevida = mean(sobrevida),
            .groups = 'drop') %>%
...
Para explorar si se verifican los supuestos del modelo, utilizamos la función `check_model()` del paquete *{performance}* y graficamos un QQ-plot, los VIF y la relación de los residuos con los valores predichos (figura 5).
...
```{r tukey_aditivo, echo=FALSE, fig.align="center", fig.height = 5, fig.width = 5, fig.cap= "Intervalos de confianza, corregidos por Tukey, del modelo aditivo."}
...
```{r check_model_log, echo=FALSE, fig.align="center", fig.height = 6, fig.width = 8, fig.cap= "Gráficas de diagnóstico del modelo con la sobrevida transformada con log()"}
...
```{r interacccion_1_boxcox, echo=FALSE, fig.align="center", fig.height = 3, fig.width = 4, fig.cap = "Gráfico de interacción entre tratamiento y tipo de veneno en la  sobrevida luego de aplicarle la función boxcox (lamdba = -0.75). El tipo de veneno está representado en el eje x mientras que el tipo de tratamiento está codificado por el color de la línea."}
data_veneno %>%
  group_by(veneno, tratamiento) %>%
...
```{r interacccion_2_boxcox, echo=FALSE, fig.align="center", fig.height = 3, fig.width = 4, fig.cap= "Gráfico de interacción entre tratamiento y tipo de veneno en la  sobrevida luego de aplicarle la función boxcox (lamdba = -0.75). El tipo de tratamiento está representado en el eje x mientras que el tipo de veneno está codificado por el color de la línea."}
data_veneno %>%
  group_by(veneno, tratamiento) %>%
  summarise(m_sobrevida = mean(boxcox_sobrevida),
            .groups = 'drop') %>%
...
```{r tukey_boxcox, echo=FALSE, fig.align="center", fig.height = 5, fig.width = 5, fig.cap= "Intervalos de confianza, corregidos por Tukey, del modelo con la sobrevida tranformada con la función boxcox (lambda = -0.75)"}
