...
Si bien el test de Tukey de nivel $\alpha = .05$ no nos permite distinguir entre el tratamiento B y D, consideramos que si tuviéramos que elegir un tratamiento sería el B.
